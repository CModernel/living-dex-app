...
import { createUserStateStorage, DEFAULT_USER_STATE, type UserState } from '@living-dex/business-logic'

const { getUserState, setUserState } = createUserStateStorage(AsyncStorage)
